<?php 
      ...
      if(count($InvoiceValues) === 0){
        ...
        echo "
            <div>
            <h1 style='text-align: center; color: #477fae; >There is no quotation to be displayed</h1>
            </div>
        ";
        exit();
...
<div  style="text-align: center; margin-top: 50px; margin-bottom: 50px;"><a href="quotations?key=' . $key . ' "  style="border: 1px solid blue; padding: 10px; box-shadow: 0px 1px 4px #bbb;" >Back to Edit</a></div>
...
<script>
  const downloadHandler = ()=> {
   window.location.href= "downloadpdfquotation.php?key='. $key . '&url=' . $logoUrl[0]['logo_url'] .' "
  }
  const print = ()=> {
